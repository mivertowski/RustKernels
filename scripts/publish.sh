#!/bin/bash
#
# RustKernels Crates Publishing Script
#
# This script publishes all RustKernels crates to crates.io in the correct
...
for arg in "$@"; do
    case $arg in
        ...
        --status)
            ...
            ;;
        --help|-h)
            echo "RustKernels Crates Publisher"
            echo ""
...
CRATES=(
    ...
    "rustkernel-ml"          # depends on: core, derive
    "rustkernel-compliance"  # depends on: core, derive
    "rustkernel-temporal"    # depends on: core, derive
    "rustkernel-risk"        # depends on: core, derive
    "rustkernel-procint"     # depends on: core
    "rustkernel-behavioral"  # depends on: core
    "rustkernel-banking"     # depends on: core
    "rustkernel-orderbook"   # depends on: core, derive
    "rustkernel-clearing"    # depends on: core
    "rustkernel-treasury"    # depends on: core
    "rustkernel-accounting"  # depends on: core
    "rustkernel-payments"    # depends on: core
...
# Main script
print_header "RustKernels Crates Publisher"

# Change to workspace root first
cd "$(dirname "$0")/.."

VERSION=$(get_crate_version "rustkernel-core")
